...
$commentStmt = $db->prepare("
    ...
    WHERE c.item_id = ? AND c.type = 'model'
...
$countStmt = $db->prepare("SELECT COUNT(*) FROM comments WHERE item_id = ? AND type = 'model'");
        ...
        <div id="Details">
            <div id="Thumbnail">
                ...
                <a id="ctl00_cphRoblox_AssetThumbnailImage" class="<?= (int)$item['category'] === 2 ? ' tshirt' : '' ?>" disabled="disabled" title="<?= htmlspecialchars($item["name"]) ?>" onclick="return false" style="display:inline-block;">
                    <img src="/Thumbs/Model.ashx?id=<?= $item["id"] ?>&x=250&y=251" alt="<?= htmlspecialchars($item["name"]) ?>" border="0">
                </a>
                <div id="Actions">
            ...
            <div id="Configuration">
                <a href="/My/Model.aspx?ID=<?= $item["id"] ?>">Configure this Model</a>
            </div>
            <?php endif; ?>
            <?php if ($ownsItem): ?>
