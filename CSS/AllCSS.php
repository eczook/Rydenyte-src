...
#Header .Navigation {
    ...
    <?php if ($theme === "rbx"): ?>
    background-color: #6e99c9;
    <?php elseif ($theme === "gubby"): ?>
    background-color: #5c5c5c;
    <?php else: ?>
    background: linear-gradient(to bottom, #000268 0%, #000146 100%);
    <?php endif; ?>
    border-bottom: solid 1px #000;
    border-left: solid 1px #000;
    border-right: solid 1px #000;
...
#BadgesContainer #CommunityBadges .Legend #Administrator {
    background-image: url(/images/Badges/Administrator-75x75.png?rand=1);
}
...
#BadgesContainer #CommunityBadges .Legend #Verified {
    ...
    background-image: url(/images/Badges/DiscordVerified.png);
}
...
#Banner {
    ...
    background-image: url(/images/Banner2.png);
    <?php elseif ($theme === "gubby"): ?>
    background-image: url(/images/GubbyBanner.png);
    background-size: 100% 100%;
    background-position: center;
    <?php else: ?>
    background-image: url(/images/CozyBanner.png);
    <?php endif; ?>
    background-repeat: no-repeat;
    border-bottom: solid 1px #000;
    border-left: solid 1px #000;
